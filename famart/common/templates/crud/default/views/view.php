...
<div class="box">
    ...
    <?= "<?= " ?>
                <?= "
                 Html::a('<i class=\"fa fa-file-pdf-o\"></i> ' . " . $generator->generateString('PDF') . ", 
                    ['pdf', $urlParams],
                    [
    ...
    <?= "            <?= Html::a('<i class=\"fa fa-pencil\"></i> ' . " . $generator->generateString('Save As New') . ", ['save-as-new', " . $generator->generateUrlParams() . "], ['class' => 'btn btn-info']) ?>" ?>
    <?php endif;?>
                <?= "
                <?= Html::a('<i class=\"fa fa-pencil\"></i> ' . " . $generator->generateString('Update') . ", ['update', " . $generator->generateUrlParams() . "], ['class' => 'btn btn-primary']) ?>
                <?= Html::a('<i class=\"fa fa-trash\"></i> ' . " . $generator->generateString('Delete') . ", ['delete', " . $generator->generateUrlParams() . "], [
                    'class' => 'btn btn-danger',
                    'data' => [
