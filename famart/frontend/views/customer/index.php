...
<div class="customer-index">
    ...
    <p>
        <?php 
            if(Yii::$app->user->identity->customer == null) {
                echo Html::a('Create Customer Order', ['create'], ['class' => 'btn btn-success']);
            }
        ?>
    </p>
    <?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-customer-search-user_id']
            ],
        'name',
        'email:email',
        [
